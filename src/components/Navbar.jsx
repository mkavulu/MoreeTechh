...
// 💡 Accept searchQuery and onSearchChange props from App.js
  ...
  return (
    <nav className={styles.navbar}>
      ...
      <div className={styles.mainNav}>
        ...
        {/* Bound click handler to reset view */}
        <Link to="/" className={styles.logo} onClick={onResetHome}>
          MOREE<span>TECH</span>
        </Link>
        
        <div className={styles.searchBar}>
          {/* 💡 Bound value and onChange listener to update state dynamically as user types */}
          <input 
            type="text" 
